...
public final class ImageUtils {
	...
	static {
		if (SystemUtils.IS_OS_WINDOWS) {
			...
			if (StringUtil.isNotEmpty(pathVariable)) {
	...
	public static void addWatermark(File srcFile, File destFile, File watermarkFile, WatermarkPosition watermarkPosition, int alpha) {
		...
		if (watermarkFile == null || !watermarkFile.exists() || !watermarkFile.isFile() || watermarkPosition == null || WatermarkPosition.no.equals(watermarkPosition)) {
			try {
				if (!StringUtil.equals(srcFile.getCanonicalPath(), destFile.getCanonicalPath())) {
