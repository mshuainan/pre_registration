...
/** madoll change :
 *  解决： 如果dialog的宽度过宽，dialog的位置显示异常（不能在操作区域中间显示，被浏览器遮住一部分）
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:null,buttonText:"...",buttonAlign:"right",inputEvents:{},accept:"",separator:",",multiple:false});
})(jQuery);
(function($){
function _510(_511){
...
//madoll change 不检验隐藏的组件
//var _551=t.find(".validatebox-invalid");
var _551=t.find(".validatebox-invalid:visible");
