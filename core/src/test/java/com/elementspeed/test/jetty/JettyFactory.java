package com.elementspeed.test.jetty;
...
public class JettyFactory{
	...
	public static Server createServerInSource(int port, String contextPath,String[] resources) {
		...
		//指定使用的web.xml描述文件
		webContext.setDescriptor("../baseproject/src/main/webapp/WEB-INF/web.xml");
		//包含的视图资源
		webContext.setBaseResource(resList);
		webContext.setWelcomeFiles(new String[]{"index.jsp"});
		// 修改webdefault.xml，解决Windows下Jetty Lock住静态文件的问题.
		webContext.setDefaultsDescriptor(WINDOWS_WEBDEFAULT_PATH);
		webContext.setMaxFormContentSize(2000000);
		webContext.setMaxFormKeys(2000000);
